(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("VideoPreview", ["react"], factory);
  ...
  var define, module, exports;return function e(t, n, r) {
    function s(o, u) {
      ...
      var chromeShim = {
        ...
        shimAddTrack: function shimAddTrack(window) {
...
exports.VideoAudioPreview = exports.VideoPreview = exports.VideoVUMeter = exports.Video = undefined;
...
function Preview(WrappedComponent) {
  return function (_Component) {
    ...
    function _class(props) {
      ...
      _this.videoBooted = false;
      _this.meterEnabled = false;
      _this.state = {
        vuMeter: 0
      };

      _this.attachAudioAnalyser = _this.attachAudioAnalyser.bind(_this);
      _this.setupMedia = _this.setupMedia.bind(_this);
      return _this;
    }
    ...
    _createClass(_class, [{
      ...
      value: function componentWillUpdate(nextProps, nextState) {
        var isSetupNeeded = !this.meterEnabled && !this.videoBooted;
        var isNewSelectedDevices = this.props.selectedAudio != nextProps.selectedAudio || this.props.selectedVideo != nextProps.selectedVideo;
        if (isSetupNeeded || isNewSelectedDevices) this.setupMedia();
      }
    }, {
      key: 'setupMedia',
      value: function setupMedia() {
        var _this2 = this;
        ...
        var _props = this.props,
            ...
            selectedAudio = _props.selectedAudio,
            selectedVideo = _props.selectedVideo;
        ...
        navigator.getMedia(streamOptions, function (stream) {
          if (audio) {
            _this2.attachAudioAnalyser(stream);
          }
          _this2.attachVideo(videoEl, stream);
          _this2.videoBooted = true;
        }, function (err) {
          console.error(err);
        });
      }
    }, {
      key: 'attachAudioAnalyser',
      value: function attachAudioAnalyser(stream) {
        var _this3 = this;
        ...
        javascriptNode.onaudioprocess = function () {
          ...
          _this3.setState(_extends({}, _this3.state, { vuMeter: average }));
          _this3.meterEnabled = true;
        };
      }
    }, {
      key: 'attachVideo',
      value: function attachVideo(element, stream) {
...
Preview.PropTypes = {
  ...
  selectedAudio: _propTypes2.default.string,
  selectedVideo: _propTypes2.default.string,
...
var VideoVUMeter = exports.VideoVUMeter = function VideoVUMeter(props) {
  return _react2.default.createElement('video', {
    id: 'webcam-preview',
    className: props.className || "video",
    height: props.height,
...
var VideoPreview = exports.VideoPreview = Preview(Video);
var VideoAudioPreview = exports.VideoAudioPreview = Preview(VideoVUMeter);
